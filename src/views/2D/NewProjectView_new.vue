...
const handleSaveProject = async () => {
  ...
  try {
    ...
    const nailsData = Object.fromEntries(
      Object.entries(projectFormRef.value.nails.value).map(([positionKey, nail]) => [
        positionKey,
        {
          height: nail.height,
          width: nail.width
    ...
    console.log('Creating project with nails data:', nailsData, 'Total nails:', Object.keys(nailsData).length)
